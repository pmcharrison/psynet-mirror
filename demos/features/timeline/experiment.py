...
from psynet.modular_page import DropdownControl, ModularPage, PushButtonControl
...
def get_timeline():
    return Timeline(
        ...
        for_loop(
            label="counting",
            iterate_over=lambda participant: list(
                range(1, participant.var.target_number + 1)
            ),
