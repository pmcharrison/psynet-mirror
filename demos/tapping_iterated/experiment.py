...
class CustomTrial(AudioImitationChainTrial):
    ...
    def show_trial(self, experiment, participant):
        ...
        return ModularPage(
            "tapping_page",
            AudioPrompt(self.origin.target_url,
                        Markup(f"""
    ...
    def analyse_recording(self, audio_file: str, output_plot: str):
        ...
        failed= not (markers_detected and markers_time_error and bad_taps and min_raw_taps and max_raw_taps)
        options = [markers_detected, markers_time_error, bad_taps, min_raw_taps, max_raw_taps]
        reasons = ["not all markers detected", "markers time error too large", "too many bad taps", "too few detected taps", "too many detected taps"]
