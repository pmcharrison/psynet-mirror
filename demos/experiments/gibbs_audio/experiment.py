...
class DemoGibbsAudioCustomTrial(AudioGibbsTrial):
...
class DemoGibbsAudioCustomNode(AudioGibbsNode):
...
trial_maker = CustomTrialMaker(
    ...
    trial_class=DemoGibbsAudioCustomTrial,
    node_class=DemoGibbsAudioCustomNode,
    ...
    start_nodes=lambda: [
        DemoGibbsAudioCustomNode(context={"target": target}) for target in TARGETS
    ],
