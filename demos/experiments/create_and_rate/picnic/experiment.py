...
class DemoCreateAndRatePicnicCreateTrial(CreateTrialMixin, ImitationChainTrial):
    time_estimate = 20
...
class DemoCreateAndRatePicnicRateTrial(RateTrialMixin, ImitationChainTrial):
    time_estimate = 20
    ...
    def format_answer(self, answer, **kwargs):
        ...
        return super(DemoCreateAndRatePicnicRateTrial, self).format_answer(
            answer, **kwargs
        )
...
class Exp(psynet.experiment.Experiment):
    ...
    timeline = Timeline(
        ...
        CreateAndRateTrialMaker(
            ...
            creator_class=DemoCreateAndRatePicnicCreateTrial,
            rater_class=DemoCreateAndRatePicnicRateTrial,
            # mixin params
