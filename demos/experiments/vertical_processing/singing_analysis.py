...
SING4ME_CONFIG = dict(
    ...
    singing_bandpass_range=[
        80,
        6000,
    ],  # in Hz - we use this to bandpass filtering the audio
    singing_bandpass_range_praat_syllable=[
        40,
        8000,
    ],  # in Hz - we use this to bandpass filter the audio for syllable extraction
