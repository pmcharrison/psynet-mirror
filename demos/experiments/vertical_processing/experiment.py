...
class VerticalProcessingTrial(StaticTrial):
    ...
    def finalize_definition(self, definition, experiment, participant):
        ...
        definition["roving_radius"] = (
            1.0  # The centre pitch of the chord roves +/- this value in semitones
        )
        definition["silence_duration"] = (
            1.0  # How long do we wait between the chord and the recording?
        )
    ...
    def show_trial(self, experiment, participant):
        ...
        return ModularPage(
            ...
            AudioRecordControl(
                ...
                bot_response_media="static/example_audio.wav",
            ),
            events={
                "recordStart": Event(
        ...
        with text:
            ...
            with tags.div():
                ...
                if self.show_running_score:
                    ...
                    tags.p(
                        "Your total score so far is ", tags.strong(running_score), "."
                    )

            target_pitches_text, sung_pitches_text, abc = (
                self.get_notation_for_feedback()
            )
    ...
    def get_notation_for_feedback(self):
        ...
        transposition = target_pitches[0] - math.floor(
            target_pitches[0]
        )  # Transpose down to the nearest integer
        ...
        sung_pitches = [
            pitch - transposition for pitch in self.var.sung_pitches
        ]  # Apply the same transposition
        ...
        sung_pitches_abc = midi_to_abc(
            sung_pitches_int
        )  # Warning: music21 errors seem to cause feedback page to be skipped
    ...
    def async_post_trial(self):
        with (
            tempfile.NamedTemporaryFile() as f_audio,
            tempfile.NamedTemporaryFile() as f_plot,
        ):
            self.assets["singing"].export(f_audio.name)
            result = singing_analysis.analyze_recording(f_audio.name, f_plot.name)
...
def overview():
    ...
    with html:
        tags.p(
            "Thank you again for participating in this experiment. Your contribution is really appreciated!"
        )
    ...
    with html:
        ...
        with tags.div():
            ...
            tags.p(
                tags.ul(
                    tags.li(
                        "If you see a dialog box requesting microphone permissions, please click 'Accept'."
                    ),
...
class MainVerticalProcessingTrialMaker(VerticalProcessingTrialMaker):
    ...
    def get_end_feedback_passed_page(self, score):
        ...
        all_scores = [
            results["score"] for results in all_results if results["score"] is not None
        ]
    ...
    with html:
        ...
        with tags.div():
            ...
            with tags.ul():
                ...
                tags.li(
                    "Sing each note for 1-2 seconds and leave a small gap between each one."
                )
...
def extra_questions():
    return ModularPage(
                        ...
                        "elements": [
                            ...
                            },
                            {
                                ...
                                "choices": [
                                    {"value": "yes", "text": "Yes"},
                                    {"value": "no", "text": "No"},
                                    {"value": "not_known", "text": "I don't know"},
                                ],
                            },
                            {
                                "type": "radiogroup",
        ...
        time_estimate=20,
        bot_response={"absolute_pitch": "Yes"},
