...
from .repp_iso import TapTrialISO, get_isochronous_stimulus, iso_tapping_instructions
from .repp_music import (
    TapTrialMusic,
    get_music_stimuli_loader,
...
isochronous_stimuli = [
    get_isochronous_stimulus(
        "iso_800ms",
        [800] * 15,
        bot_response="data/iso_bot_responses/example_iso_slow_tap.wav",
    ),
    get_isochronous_stimulus(
        "iso_600ms",
        [600] * 12,
        bot_response="data/iso_bot_responses/example_iso_fast_tap.wav",
    ),
]
