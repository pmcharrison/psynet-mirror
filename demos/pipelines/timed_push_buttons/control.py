...
class SingleTimedPushButtonControl(TimedPushButtonControl):
    ...
    def format_answer(self, raw_answer, **kwargs):
        ...
        audio_start = [
            t["localTime"] for t in event_log if t["eventType"] == "promptStart"
        ]
        push_button_times = [
            t["localTime"] for t in event_log if t["eventType"] == "pushButtonClicked"
        ]
        ...
        push_button_times = [
            datetime.strptime(t, date_format) for t in push_button_times
        ]
