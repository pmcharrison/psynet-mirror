...
## Release candidates (optional, minor releases)

For minor releases that need wider testing before the final tag, publish one
or more release candidates (RCs) from the release branch first. RCs are
