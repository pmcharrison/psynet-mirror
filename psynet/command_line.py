...
def scripts_prune(force):
    ...
    ``README.md`` is always preserved. Paths that differ from current PsyNet
    templates, including ``config.txt``, are preserved by default because they
    may be customized or generated by another PsyNet version. ``--force`` removes
    those paths without checking their contents.
    """
