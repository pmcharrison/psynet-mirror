(function () {
    ...
    let beforeunloadFunction = function () {};
                ...
                psynet.nextPage = async function (rawAnswer, metadata, blobs, onRejection) {
                    if (!psynet.pageLoaded) {
                        psynet.alert(
                            psynetTemplateData.strings.pageLoadNotReady
                        )
                        return false;
                    }
        ...
        function writeToDbParticipantOpenedDevtools() {
            dallinger.post(
                psynetTemplateData.routes.participantOpenedDevtools
            );
        }
    ...
    psynet.initLucidTermination = function () {
        ...
        const NO_FOCUS_TIMEOUT_REASON = psynetTemplateData.lucid.noFocusTimeoutReason;
