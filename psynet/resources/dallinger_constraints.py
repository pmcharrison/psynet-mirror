...
# Vendored from Dallinger's ``dallinger/constraints.py`` for thin-bootstrap
# ``uv run`` locking without importing the full Dallinger package.
# Prefer the installed ``dallinger.constraints`` module when available;
# refresh this copy when bumping the Dallinger dependency.
#
