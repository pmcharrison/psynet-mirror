...
def prune_experiment_scaffold(*, preserve_files=None, force=False):
    ...
    if preserved_unrecognized:
        ...
        click.echo(
            "Before running 'psynet scripts prune --force', review them and commit "
            "or back up anything you need."
        )
        click.echo(
            "'--force' deletes these paths without checking their contents; "
            "PsyNet cannot undo the deletion."
        )
