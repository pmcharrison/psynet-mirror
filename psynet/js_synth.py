...
class ShepardTimbre(ADSRTimbre):
    ...
    partials (e.g. in a harmonic complex tone) is augmented by 2 * n_octave_transpositions octaves,
    ...
    **kwargs:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self["n_harmonics"] = 1
        self.n_octave_transpositions = n_octave_transpositions
        self["n_octave_transpositions"] = n_octave_transpositions
...
class InstrumentTimbre(Timbre):
    ...
    def __init__(self, type: str, samples: Optional[dict] = None, base_url=""):
        ...
        self["n_octave_transpositions"] = 0
...
class JSSynth(Prompt):
    ...
    def __init__(
        ...
        options = dict(
            max_n_pitches=0,
            max_n_harmonics=1,
            max_n_octave_transpositions=0,
            instruments=[],
        )

        def consolidate_chord(chord):
            x = chord.copy()
            options["max_n_pitches"] = max(options["max_n_pitches"], len(x["pitches"]))
        ...
        for t in timbre.values():
            ...
            if hasattr(t, "n_octave_transpositions"):
                options["max_n_octave_transpositions"] = max(
                    options["max_n_octave_transpositions"],
                    t.n_octave_transpositions,
                )
