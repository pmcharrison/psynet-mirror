...
def countries(locale=None):
    ...
    return [
        ...
        ("BO", _p("country_name", "Bolivia, Plurinational State of")),
        ...
        ("CC", _p("country_name", "Cocos (Keeling) Islands")),
        ("CO", _p("country_name", "Colombia")),
        ("KM", _p("country_name", "Comoros")),
        ("CG", _p("country_name", "Congo")),
        ("CD", _p("country_name", "Congo, The Democratic Republic of the")),
        ...
        ("VA", _p("country_name", "Holy See (Vatican City State)")),
        ...
        ("IR", _p("country_name", "Iran, Islamic Republic of")),
        ...
        ("KP", _p("country_name", "Korea, Democratic People's Republic of")),
        ("KR", _p("country_name", "Korea, Republic of")),
        ("KW", _p("country_name", "Kuwait")),
        ("KG", _p("country_name", "Kyrgyzstan")),
        ("LA", _p("country_name", "Lao People's Democratic Republic")),
        ...
        ("FM", _p("country_name", "Micronesia, Federated States of")),
        ("MD", _p("country_name", "Moldova, Republic of")),
        ...
        ("PS", _p("country_name", "Palestine, State of")),
        ...
        ("MF", _p("country_name", "Saint Martin (French part)")),
        ...
        ("SX", _p("country_name", "Sint Maarten (Dutch part)")),
        ...
        ("SY", _p("country_name", "Syrian Arab Republic")),
        ("TW", _p("country_name", "Taiwan, Province of China")),
        ("TJ", _p("country_name", "Tajikistan")),
        ("TZ", _p("country_name", "Tanzania, United Republic of")),
        ...
        ("VE", _p("country_name", "Venezuela, Bolivarian Republic of")),
        ("VN", _p("country_name", "Viet Nam")),
...
def languages(locale=None):
    ...
    return [
        ...
        ("ia", _p("language_name", "Interlingua (International Auxiliary Language Association)")),
        ...
        ("ms", _p("language_name", "Malay (macrolanguage)")),
        ...
        ("oc", _p("language_name", "Occitan (post 1500)")),
        ("oj", _p("language_name", "Ojibwa")),
        ("or", _p("language_name", "Oriya (macrolanguage)")),
        ...
        ("sw", _p("language_name", "Swahili (macrolanguage)")),
        ...
        ("to", _p("language_name", "Tonga (Tonga Islands)")),
