...
- Fixed `test_warnings` to filter out external Heroku CLI and Node launch warnings (including terms-of-service notices) so it only fails on PsyNet-originated warnings (author: Frank Höger, reviewer: Peter Harrison)
