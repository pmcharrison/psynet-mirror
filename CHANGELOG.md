...
### Fixed
- Scoped graph-chain fast-path growth checks to affected downstream networks and added supporting readiness indexes to avoid slow participant response submissions in large graph experiments (author: [Cursor])
