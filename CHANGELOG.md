...
- Queried only required columns in the Gibbs basic_data export test (author: Peter)
...
- Exported basic data with local exports, using JSON by default and a CSV folder when returned as DataFrames (author: Peter)
