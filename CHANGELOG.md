...
- Avoided eager config loading in S3 tests by seeding AWS credentials in config, and skipped Dallinger's module reset to prevent SQLAlchemy class re-registration warnings (author: Cursor, reviewer: Peter Harrison)
