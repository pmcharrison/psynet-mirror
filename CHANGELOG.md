...
- Updated docs deployment to publish versioned docs from their own git refs (stable tags plus alpha from the default branch) and expose those versions in the PyData theme switcher (author: Frank Höger)
