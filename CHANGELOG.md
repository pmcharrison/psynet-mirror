...
## Fixed
- Disallow PsyNet requirements pinned to master for non-local deployments while allowing local deployments to proceed (author: Peter Harrison)
- Clarified local debugging wording in PsyNet requirement warning (author: Peter Harrison)
