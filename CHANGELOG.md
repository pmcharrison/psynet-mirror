...
## Fixed
- Installed demo dependencies via Dallinger constraints extras (Docker/CI) to avoid RequestsDependencyWarning from unpinned transitive packages (author: Peter Harrison)
