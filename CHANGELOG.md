...
## Changed
- Deprecated `Asset.set_keys` in favor of `set_missing_keys` for clarity (author: [Peter Harrison])
- Deprecated `Asset.set_missing_keys` in favor of `ensure_keys_and_paths` for clarity (author: [Peter Harrison])
