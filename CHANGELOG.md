...
## Fixed
- Generated demo constraints during Docker builds so demo dependencies stay aligned with base constraints, avoiding RequestsDependencyWarning in CI (author: Peter Harrison)
