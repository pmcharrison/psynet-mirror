...
- Avoided eager config loading in S3 tests by using Dallinger's stub_config for initial Moto bucket creation, and skipped Dallinger's module reset to prevent SQLAlchemy class re-registration warnings (author: Cursor, reviewer: Peter Harrison)
