...
- Use repo-relative file paths for SQLAlchemy polymorphic identities to prevent collisions when loading multiple experiments in one session (author: Cursor, reviewer: Peter Harrison)
