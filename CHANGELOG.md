...
- Fixed `adaptive_test_catr` catR integration to call `thetaEst`/`semTheta` with the correct catR argument conventions for administered-item subsets, resolving local runtime failures after dependencies are installed (author: Peter Harrison)
