...
- Marked full-build CI jobs as non-interruptible so docs-only commits do not cancel them (author: Cursor, reviewer: Peter Harrison)
- Removed workflow rules that skipped entire pipelines in favor of job-level skipping for merged results reliability (author: Cursor, reviewer: Peter Harrison)
...
- Tweaked history documentation wording for web server phrasing (author: Cursor, reviewer: Peter Harrison)
