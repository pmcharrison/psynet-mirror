...
def test_summarise():
    ...
    class Node3(GibbsNode):
        ...
        kernel_width = [1]
    n3 = make_gibbs_node(Node3)

    class Node4(GibbsNode):
        summarise_trials_method = "kernel_mode"
        kernel_width = [7]
    n4 = make_gibbs_node(Node4)
