    ...
    def test_abort(self, bot_recruits, db_session):
        ...
        for participant, bot in enumerate(bot_recruits):
            ...
            assert_text(
                driver,
                "error-text-main",
                "You may be able to abort the experiment using the Abort experiment button below. Once aborted, there is no need to contact us to receive the compensation; this should be awarded to you automatically shortly. If this is not the case, please contact us at XXX@gmail.com quoting the following information:",
                # TODO make this recruiter-specific?
