...
================================
Audio or Video Gibbs Sampling with People
================================

An Audio or Video Gibbs Sampling with People
experiment depends on the five following classes:

* :class:`~psynet.trial.media_gibbs.AudioGibbsNetwork`
* :class:`~psynet.trial.media_gibbs.AudioGibbsSource`;
* :class:`~psynet.trial.media_gibbs.AudioGibbsNode`;
* :class:`~psynet.trial.media_gibbs.AudioGibbsTrial`;
* :class:`~psynet.trial.media_gibbs.AudioGibbsTrialMaker`

or

* :class:`~psynet.trial.media_gibbs.VideoGibbsNetwork`
* :class:`~psynet.trial.media_gibbs.VideoGibbsSource`;
* :class:`~psynet.trial.media_gibbs.VideoGibbsNode`;
* :class:`~psynet.trial.media_gibbs.VideoGibbsTrial`;
* :class:`~psynet.trial.media_gibbs.VideoGibbsTrialMaker`

respectively.

You can define a custom Audio Gibbs sampling experiment through the following steps (instructions for video
are analogue):
...
1. Decide on a set of fixed parameters that will stay constant within
   ...
   Implement a subclass of :class:`~psynet.trial.media_gibbs.AudioGibbsNetwork`
   with a custom :meth:`~psynet.trial.media_gibbs.AudioGibbsNetwork.make_definition` method
...
2. Decide on a vector of free parameters that will define the parameter space
   ...
   :attr:``~psynet.trial.media_gibbs.AudioGibbsNetwork.vector_length`` attribute
   for your custom :class:`~psynet.trial.media_gibbs.AudioGibbsNetwork` class.
...
3. Decide on the permitted ranges for these free parameters
   ...
   :attr:``~psynet.trial.media_gibbs.AudioGibbsNetwork.vector_ranges`` attribute
   for your custom :class:`~psynet.trial.media_gibbs.AudioGibbsNetwork` class.
...
4. Decide on the granularity for audio synthesis (i.e. how many audio files will
   ...
   :attr:``~psynet.trial.media_gibbs.AudioGibbsNetwork.granularity`` attribute
   for your custom :class:`~psynet.trial.media_gibbs.AudioGibbsNetwork` class.
...
5. Implement a synthesis function that generates an audio file according to
   ...
   :attr:``~psynet.trial.media_gibbs.AudioGibbsNetwork.synth_function`` attribute
   for your custom :class:`~psynet.trial.media_gibbs.AudioGibbsNetwork` class
   (see the documentation for more details).

6. Decide on an S3 bucket in which to store your stimuli.
   Save the name of this bucket in the
   :attr:``~psynet.trial.media_gibbs.AudioGibbsNetwork.s3_bucket`` attribute
   for your custom :class:`~psynet.trial.media_gibbs.AudioGibbsNetwork` class.

5. Implement a subclass of :class:`~psynet.trial.media_gibbs.AudioGibbsTrial`
   with a custom
   :meth:`~psynet.trial.media_gibbs.AudioGibbsTrial.get_prompt` method.
   This :meth:`~psynet.trial.media_gibbs.AudioGibbsTrial.get_prompt` method
   should determine the prompt shown to the user above their slider.

6. Import the :class:`~psynet.trial.media_gibbs.AudioGibbsNode` class; typicaly this will not
   need to be customised.

7. Import the :class:`~psynet.trial.media_gibbs.AudioGibbsSource` class; typicaly this will not
   need to be customised.

8. Create an instance of :class:`~psynet.trial.media_gibbs.AudioGibbsMaker`,
...
:meth:`~psynet.trial.media_gibbs.AudioGibbsTrialMaker.custom_network_filter` method.
