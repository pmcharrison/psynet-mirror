...
parser.add_argument('--type', type=str, help='Instance type',
default='m5.2xlarge')

parser.add_argument('--storage', type=int, help='Storage in GB',
default=32)
...
parser.add_argument('--security', type=str, help='Security group name',
default='cap')
