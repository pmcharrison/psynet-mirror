...
:doc:`Version control with Git </tutorials/version_control_with_git>`.
...
-   ``static`` can be used as a storage place for files that the front-end browser can access directly via HTTP.
    ...
    see :doc:`Assets </tutorials/assets>` for more details.
...
-   ``templates`` is used for customising PsyNet’s front-end. It contains
    ...
    :doc:`Writing custom frontends </tutorials/writing_custom_frontends>`.
