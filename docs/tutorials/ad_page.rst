...
the recruitment method being used, `CAP-Recruiter`, `Lucid`, `MTurk`, and `Prolific` participants are presented a specific ad page, of which three sections can be customized. These are:
